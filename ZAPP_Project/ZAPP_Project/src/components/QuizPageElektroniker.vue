  ...
  <div id="app">
    ...
    <div class="quiz-page">
      ...
      <div v-else>
        ...
        <button class="zapp-button" @click="$router.push('/beruf/elektroniker')">Zurück zum Elektroniker</button>
      </div>
...
export default {
  ...
  data() {
    return {
      questions: [
        {
          text: 'Was ist die Hauptaufgabe eines/einer Elektroniker*in?',
          answers: [
            { text: 'Elektrische Anlagen installieren', correct: true },
        ...
        {
          text: 'Welche Werkzeuge benutzt ein/e Elektroniker*in häufig?',
          answers: [
            { text: 'Hammer und Nägel', correct: false },
            { text: 'Schraubendreher und Multimeter', correct: true },
            { text: 'Pinsel und Farben', correct: false },
            { text: 'Stifte und Papier', correct: false }
          ]
        },
        {
          text: 'In welcher Branche arbeiten Elektroniker*innen hauptsächlich?',
          answers: [
            { text: 'Gesundheitswesen', correct: false },
            { text: 'Bauwesen', correct: false },
            { text: 'Elektroindustrie', correct: true },
            { text: 'Landwirtschaft', correct: false }
          ]
        },
        {
          text: 'Was gehört zu den Aufgaben eines/einer Elektroniker*in?',
          answers: [
            { text: 'Kabel verlegen', correct: true },
        ...
        {
          text: 'Welche Ausbildung benötigt man, um Elektroniker*in zu werden?',
          answers: [
        ...
        {
          text: 'Welche Materialien bearbeitet ein/e Elektroniker*in?',
          answers: [
            { text: 'Holz', correct: false },
            { text: 'Metall', correct: false },
            { text: 'Glas', correct: false },
            { text: 'Kabel und Leiterplatten', correct: true }
          ]
        },
        {
          text: 'Was ist ein typisches Arbeitsumfeld für Elektroniker*innen?',
          answers: [
            { text: 'Büro', correct: false },
            { text: 'Werkstatt', correct: true },
            { text: 'Krankenhaus', correct: false },
            { text: 'Schule', correct: false }
          ]
        },
        {
          text: 'Welche Geräte installieren Elektroniker*innen?',
          answers: [
            { text: 'Computer', correct: false },
            { text: 'Elektrische Anlagen', correct: true },
            { text: 'Küchenmaschinen', correct: false },
            { text: 'Sportgeräte', correct: false }
          ]
        },
        {
          text: 'Welche Sicherheitsausrüstung tragen Elektroniker*innen?',
          answers: [
            { text: 'Schutzbrille und Helm', correct: true },
            { text: 'Schürze und Handschuhe', correct: false },
            { text: 'Kittel und Stethoskop', correct: false },
            { text: 'Anzug und Krawatte', correct: false }
          ]
        },
        {
          text: 'Welche Fähigkeiten sind für Elektroniker*innen wichtig?',
          answers: [
            { text: 'Kreativität', correct: false },
            { text: 'Technisches Verständnis', correct: true },
