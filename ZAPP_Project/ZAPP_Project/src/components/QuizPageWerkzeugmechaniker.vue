  ...
  <div id="app">
    ...
    <div class="quiz-page">
      ...
      <div v-else>
        ...
        <button class="zapp-button" @click="$router.push('/beruf/werkzeugmechaniker')">Zurück zum Werkzeugmechaniker</button>
      </div>
...
export default {
  ...
  data() {
    return {
      questions: [
        {
          text: 'Was ist die Hauptaufgabe eines/einer Werkzeugmechaniker*in?',
          answers: [
            { text: 'Werkzeuge und Formen herstellen', correct: true },
        ...
        {
          text: 'Welche Werkzeuge benutzt ein/e Werkzeugmechaniker*in häufig?',
          answers: [
            { text: 'Hammer und Nägel', correct: false },
            { text: 'Feilen und Fräsmaschinen', correct: true },
            { text: 'Pinsel und Farben', correct: false },
            { text: 'Stifte und Papier', correct: false }
          ]
        },
        {
          text: 'In welcher Branche arbeiten Werkzeugmechaniker*innen hauptsächlich?',
          answers: [
            { text: 'Gesundheitswesen', correct: false },
            { text: 'Bauwesen', correct: false },
            { text: 'Maschinenbau/Industrie', correct: true },
            { text: 'Landwirtschaft', correct: false }
          ]
        },
        {
          text: 'Was gehört zu den Aufgaben eines/einer Werkzeugmechaniker*in?',
          answers: [
            { text: 'Werkzeuge reparieren', correct: true },
        ...
        {
          text: 'Welche Ausbildung benötigt man, um Werkzeugmechaniker*in zu werden?',
          answers: [
        ...
        {
          text: 'Welche Materialien bearbeitet ein/e Werkzeugmechaniker*in?',
          answers: [
            { text: 'Holz', correct: false },
            { text: 'Metall', correct: true },
            { text: 'Glas', correct: false },
            { text: 'Kunststoff', correct: false }
          ]
        },
        {
          text: 'Was ist ein typisches Arbeitsumfeld für Werkzeugmechaniker*innen?',
          answers: [
        ...
        {
          text: 'Welche Maschinen bedienen Werkzeugmechaniker*innen?',
          answers: [
            { text: 'Fräsmaschinen', correct: true },
        ...
        {
          text: 'Welche Sicherheitsausrüstung tragen Werkzeugmechaniker*innen?',
          answers: [
        ...
        {
          text: 'Welche Fähigkeiten sind für Werkzeugmechaniker*innen wichtig?',
          answers: [
            { text: 'Kreativität', correct: false },
            { text: 'Handwerkliches Geschick', correct: true },
