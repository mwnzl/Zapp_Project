  ...
  <div id="app">
    ...
    <div class="quiz-page">
      ...
      <div v-else>
        ...
        <button class="zapp-button" @click="$router.push('/beruf/industriemechaniker')">Zurück zum Industriemechaniker</button>
      </div>
...
export default {
  ...
  data() {
    return {
      questions: [
        {
          text: 'Was ist die Hauptaufgabe eines/einer Industriemechaniker*in?',
          answers: [
            { text: 'Maschinen und Anlagen warten', correct: true },
        ...
        {
          text: 'Welche Werkzeuge benutzt ein/e Industriemechaniker*in häufig?',
          answers: [
            { text: 'Hammer und Nägel', correct: false },
            { text: 'Schraubenschlüssel und Zangen', correct: true },
            { text: 'Pinsel und Farben', correct: false },
            { text: 'Stifte und Papier', correct: false }
          ]
        },
        {
          text: 'In welcher Branche arbeiten Industriemechaniker*innen hauptsächlich?',
          answers: [
        ...
        {
          text: 'Was gehört zu den Aufgaben eines/einer Industriemechaniker*in?',
          answers: [
            { text: 'Maschinen reparieren', correct: true },
        ...
        {
          text: 'Welche Ausbildung benötigt man, um Industriemechaniker*in zu werden?',
          answers: [
        ...
        {
          text: 'Welche Materialien bearbeitet ein/e Industriemechaniker*in?',
          answers: [
        ...
        {
          text: 'Was ist ein typisches Arbeitsumfeld für Industriemechaniker*innen?',
          answers: [
        ...
        {
          text: 'Welche Maschinen bedienen Industriemechaniker*innen?',
          answers: [
            { text: 'Bohrmaschinen', correct: true },
        ...
        {
          text: 'Welche Sicherheitsausrüstung tragen Industriemechaniker*innen?',
          answers: [
        ...
        {
          text: 'Welche Fähigkeiten sind für Industriemechaniker*innen wichtig?',
          answers: [
