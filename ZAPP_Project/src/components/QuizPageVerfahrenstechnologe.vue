  ...
  <div id="app">
    ...
    <div class="quiz-page">
      ...
      <div v-else>
        ...
        <button class="zapp-button" @click="$router.push('/beruf/verfahrenstechnologe')">Zurück zum Verfahrenstechnologen</button>
      </div>
...
export default {
  ...
  data() {
    return {
      questions: [
        {
          text: 'Was ist die Hauptaufgabe eines/einer Verfahrenstechnologe/in?',
          answers: [
            { text: 'Prozesse überwachen', correct: true },
        ...
        {
          text: 'Welche Werkzeuge benutzt ein/e Verfahrenstechnologe/in häufig?',
          answers: [
            { text: 'Hammer und Nägel', correct: false },
            { text: 'Messgeräte und Computer', correct: true },
            { text: 'Pinsel und Farben', correct: false },
            { text: 'Stifte und Papier', correct: false }
          ]
        },
        {
          text: 'In welcher Branche arbeiten Verfahrenstechnolog*innen hauptsächlich?',
          answers: [
        ...
        {
          text: 'Was gehört zu den Aufgaben eines/einer Verfahrenstechnologe/in?',
          answers: [
            { text: 'Produktionsprozesse optimieren', correct: true },
        ...
        {
          text: 'Welche Ausbildung benötigt man, um Verfahrenstechnologe/in zu werden?',
          answers: [
        ...
        {
          text: 'Welche Materialien bearbeitet ein/e Verfahrenstechnologe/in?',
          answers: [
        ...
        {
          text: 'Was ist ein typisches Arbeitsumfeld für Verfahrenstechnolog*innen?',
          answers: [
        ...
        {
          text: 'Welche Produkte stellen Verfahrenstechnolog*innen her?',
          answers: [
        ...
        {
          text: 'Welche Sicherheitsausrüstung tragen Verfahrenstechnolog*innen?',
          answers: [
        ...
        {
          text: 'Welche Fähigkeiten sind für Verfahrenstechnolog*innen wichtig?',
          answers: [
